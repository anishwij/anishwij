// components/CookieConsent.jsx - SIMPLIFIED
'use client'
...
export default function CookieConsent() {
  ...
  useEffect(() => {
    // Only check if we need to show banner
    ...
    <div className='fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 p-4 shadow-lg z-50 border-t'>
      <div className='max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4'>
        <p className='text-sm text-gray-600 dark:text-gray-300'>
          We use cookies to improve your experience and analyze site traffic. By clicking &ldquo;Accept All&rdquo;, you consent to
          our use of cookies.
        </p>
